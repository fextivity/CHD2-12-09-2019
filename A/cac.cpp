...
signed main(){
	...
	*/
    ofstream out;
    ForE(test, 1, tests){
        string com1 = "rename \"TEST00\\input.in\" test00.in";
        string com2 = "rename \"TEST00\\output.ans\" test00.ans";
        // Real string: rename "TEST00\input.in" test00.in ---- rename "TEST00\output.ans" test00.ans
        com1[com1.length() - 5] = (char)('0' + test / 10);
        com1[com1.length() - 4] = (char)('0' + test % 10);
        com1[com1.length() - 22] = (char)('0' + test / 10);
        com1[com1.length() - 21] = (char)('0' + test % 10);
        com2[com2.length() - 6] = (char)('0' + test / 10);
        com2[com2.length() - 5] = (char)('0' + test % 10);
        com2[com2.length() - 25] = (char)('0' + test / 10);
        com2[com2.length() - 24] = (char)('0' + test % 10);
